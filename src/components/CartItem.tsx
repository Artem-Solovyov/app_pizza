...
import {addItems, CartItemType, minusItem, removeItems} from "../redux/cartSlice";
...
const CartItem: React.FC<PropsType> = ({id, title, price, count, imageUrl, type, size}) => {
  ...
  const onClickRemove = () => {
    if (window.confirm('Видалити данний товар?')) {
